  ...
  public: {
    Tables: {
      ...
      exploration_sites: {
        ...
        Relationships: [
          {
            foreignKeyName: "exploration_sites_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
      ...
      mineral_deposits: {
        ...
        Relationships: [
          {
            foreignKeyName: "mineral_deposits_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
          ...
          {
            foreignKeyName: "mineral_deposits_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "exploration_sites"
            referencedColumns: ["id"]
          },
        ]
      }
      predictions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "predictions_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "exploration_sites"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      rotate_encryption_key: {
        Args: { new_key: string; old_key: string }
        Returns: undefined
      }
